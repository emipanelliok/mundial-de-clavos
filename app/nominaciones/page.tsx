    ...
    return (
      <main className="min-h-screen flex flex-col items-center justify-center px-4 py-12">
        <div className="max-w-sm w-full text-center space-y-4">
          <h1 className="font-display text-4xl text-cream">CLASIFICACIÓN CERRADA</h1>
          <p className="text-muted text-sm">Ya no se aceptan nuevos clasificados. El mundial está en marcha.</p>
          <Link href="/fixture" className="inline-block bg-rust text-ink font-display text-xl px-6 py-3 rounded-2xl tracking-wide">
            VER FIXTURE
          </Link>
        </div>
      </main>
