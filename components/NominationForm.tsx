      ...
      <div className="flex flex-col items-center gap-6 py-8 text-center">
        ...
        <a
          href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(
            "Ya voté en el Mundial de Autos Clavo 2026 🔩🏆\n\n¿Cuáles son tus 5 clavos? Votá vos acá 👇"
          )}&url=${encodeURIComponent("https://mundial-de-clavos.vercel.app")}`}
          target="_blank"
          rel="noopener noreferrer"
          className="w-full flex items-center justify-center gap-3 bg-ink text-white font-display text-2xl py-4 rounded-2xl tracking-wider hover:bg-ink/90 active:scale-[0.98] transition-all"
        >
        ...
        <p className="text-xs text-muted">Invitá a tus amigos a votar. El ranking se revela cuando cierre la clasificación.</p>
      </div>
    );
  }
